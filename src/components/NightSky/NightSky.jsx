...
const starMessages = {
  sirius: {
    title: "✨ Sirius",
    message:
      "The brightest star in the sky, standing bold and clear...\nJust like the confidence you carry yourself with.",
  },
  betelgeuse: {
    title: "🔴 Betelgeuse",
    message:
      "A red supergiant with a presence that can’t be ignored...\nYou have that same rare, magnetic energy.",
  },
  rigel: {
    title: "💙 Rigel",
    message:
      "A star known for its incredible strength and light...\nIt reminds me of how resilient and sweet you are.",
  },
  pollux: {
    title: "🌟 Pollux",
    message:
      "One of the Great Twins, steady and bright...\nI’m really glad I’m getting to know your world.",
  },
};
          ...
          {showSecretMessage && (
            ...
            >
              ...
              >
                ...
                >
                  I wanted you to see what the sky looked like the day you were
                  born. The Moon was hidden that night, but I like to think it
                  was just making room for a different kind of glow to begin.
                  You’re like a sunflower, you don't need the moon when you
                  carry your own sun with you.
                </p>
        ...
        <div className="memories-content">
          ...
          >
            ...
            <p className="final-subtext">
              The Moon stepped aside that night, knowing a brighter light was
              about to be born.
            </p>
          </motion.div>
        </div>
